...
function my_publicnotices()
 {
      global $post;

      $html = "";

      $my_query = new WP_Query( array('category_name' => 'public-notices',
           'post_type' => 'post',
...
$feat_image = wp_get_attachment_url( get_post_thumbnail_id($post->ID) );
		   ...
		   $html .= "
                            <li><a href=\"" . get_permalink() . "\"><img src='".$feat_image."' width='104' height='104'/> 
                            <h3>" . get_the_title() . "</h3>
		   <p>" . get_the_excerpt() . "</a></p></li>";
...
$html .= "</ul>";
 ...
 add_shortcode( 'publicnotices', 'my_publicnotices' );

function my_seewhatson()
 {
      global $post;

      $html = "";

      $my_query = new WP_Query( array('category_name' => 'see-whats-on',
           'post_type' => 'post',
...
$html .= "</ul>";
 ...
 add_shortcode( 'seewhatson', 'my_seewhatson' );
